@extends('layouts.app')
@section("breadcrumb")
<li class="breadcrumb-item active">@lang('fleet.packages')</li>
@endsection
@section('extra_css')
<style type="text/css">
  .checkbox, #chk_all{
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">@lang('fleet.packages') &nbsp;
        <a href="{{ route('packages.create')}}" class="btn btn-success">@lang('fleet.addNew')</a></h3>
      </div>
        ...
        <table class="table" id="data_table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                {{ Hyvikk::get('currency') ." ". $row->km_rate }}
              </td>
              <td>
              <div class="btn-group">
              ...
              <a class="dropdown-item" href="{{url("admin/packages/".$row->id."/edit") }}"> <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> @lang('fleet.edit')</a>
              ...
              {!! Form::open(['url' => 'admin/packages/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]) !!}
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        {!! Form::open(['url'=>'admin/delete-packages','method'=>'POST','id'=>'form_delete']) !!}
