        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="input-group mb-3">
              ...
              {!! Form::number('package_hours', $data->package_hours,['class' => 'form-control','required','step'=>'0.01']) !!}
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="input-group mb-3">
              ...
              {!! Form::number('package_rate', $data->package_rate,['class' => 'form-control','required','step'=>'0.01']) !!}
            </div>
          </div>
        </div>
      </div>
