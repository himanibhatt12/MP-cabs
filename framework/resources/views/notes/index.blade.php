  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        ...
        @lang('fleet.notes')
        &nbsp;
        <a href="{{ route('notes.create')}}" class="btn btn-success">@lang('fleet.create_note')</a></h3>
      </div>
        ...
        <table class="table" id="data_table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
              {{date('d-m-Y',strtotime($row->submitted_on))}}
              </td>
              <td>{{$row->note}}</td>
              <td> {{$row->status}} </td>
              <td>
              <div class="btn-group">
                ...
                <div class="dropdown-menu custom" role="menu">
                  <a class="dropdown-item" href="{{ url("admin/notes/".$row->id."/edit")}}"> <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> @lang('fleet.edit')</a>
