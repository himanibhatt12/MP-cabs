  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        ...
        <a href="{{ route('vehicle-model.create')}}" class="btn btn-success">@lang('fleet.addNew')</a></h3>
      </div>
        ...
        <table class="table" id="data_table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <a class="dropdown-item" href="{{url("admin/vehicle-model/".$row->id."/edit") }}"> <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> @lang('fleet.edit')</a>
