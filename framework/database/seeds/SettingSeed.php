...
class SettingSeed extends Seeder {
	...
	private function payment_settings() {
		...
		PaymentSettings::create(['name' => 'stripe_publishable_key', 'value' => 'pk_test_PDSe3CSJbfHlDWNEkuGRVteH']);
		PaymentSettings::create(['name' => 'stripe_secret_key', 'value' => 'sk_test_0F3QoeJeqlUYdSH3IEYIR6e3']);
		PaymentSettings::create(['name' => 'razorpay_key', 'value' => 'rzp_test_3D43rMt6XaLCjd']);
		PaymentSettings::create(['name' => 'razorpay_secret', 'value' => 'dbNODBnnq5KYLyJm2Iv76aXz']);
	}
}