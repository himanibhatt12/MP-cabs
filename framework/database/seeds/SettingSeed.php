...
class SettingSeed extends Seeder
{
    ...
    private function payment_settings()
    {
        ...
        PaymentSettings::create(['name' => 'stripe_publishable_key', 'value' => null]);
        PaymentSettings::create(['name' => 'stripe_secret_key', 'value' => null]);
        PaymentSettings::create(['name' => 'razorpay_key', 'value' => null]);
        PaymentSettings::create(['name' => 'razorpay_secret', 'value' => null]);
    }
}
