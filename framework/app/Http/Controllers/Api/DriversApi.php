...
class DriversApi extends Controller
{
    ...
    public function get_settings()
    {
        ...
        $data['data'] = array(
            ...
            'base_waiting_time' => Hyvikk::fare('base_time'),
            'weekend_base_fare' => Hyvikk::fare('weekend_base_fare'),
            'weekend_base_km' => Hyvikk::fare('weekend_base_km'),
            'weekend_wait_time' => Hyvikk::fare('weekend_wait_time'),
            'weekend_std_fare' => Hyvikk::fare('weekend_std_fare'),
            'night_base_fare' => Hyvikk::fare('night_base_fare'),
            'night_base_km' => Hyvikk::fare('night_base_km'),
            'night_wait_time' => Hyvikk::fare('night_wait_time'),
            'night_std_fare' => Hyvikk::fare('night_std_fare'),
            'reasons' => $reason,
