...
class NotesController extends Controller
{
    public function index()
    {
        if (Auth::User()->user_type == "S") {
            $index['data'] = NotesModel::get();
        } else {
            $index['data'] = NotesModel::where('customer_id', Auth::User()->id)->get();
        }
    ...
    public function create()
    {
        if (Auth::user()->group_id == null || Auth::user()->user_type == "S") {
            ...
            $data['vehicles'] = VehicleModel::where('user_id', Auth::id())->where('group_id', Auth::user()->group_id)->whereIn_service("1")->get();
        }
    ...
    public function edit($id)
    {
        if (Auth::user()->group_id == null || Auth::user()->user_type == "S") {
            ...
            $index['vehicles'] = VehicleModel::where('user_id', Auth::id())->where('group_id', Auth::user()->group_id)->whereIn_service("1")->get();
        }
