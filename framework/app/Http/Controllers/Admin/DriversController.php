...
class DriversController extends Controller
{
    ...
    public function index()
    {
        if (Auth::user()->user_type == "S") {
            ...
            $index['data'] = User::where('user_id', Auth::id())->whereUser_type("D")->get();
    ...
    public function create()
    {
        ...
        if (Auth::user()->user_type == "S") {
            ...
            $data['vehicles'] = VehicleModel::where('user_id', Auth::id())->whereNotIn('id', $exclude)->get();
    ...
    public function edit(User $driver)
    {
        ...
        if (Auth::user()->group_id == null || Auth::user()->user_type == "S") {
            ...
            $vehicles = VehicleModel::where('user_id', Auth::id())->where('group_id', Auth::user()->group_id)->whereNotIn('id', $exclude)->orWhere('id', $driver->vehicle_id)->get();
        }
