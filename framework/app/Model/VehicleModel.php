...
class VehicleModel extends Model
{
    ...
    protected $fillable = ['make', 'model', 'type', 'year', 'engine_type', 'horse_power', 'color', 'vin', 'license_plate', 'mileage', 'int_mileage', 'in_service', 'user_id', 'insurance_number', 'documents', 'vehicle_image', 'exp_date', 'reg_exp_date', 'lic_exp_date', 'group_id', 'type_id', 'model_id', 'make_id', 'color_id'];
